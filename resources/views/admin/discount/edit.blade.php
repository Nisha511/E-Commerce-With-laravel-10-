                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="code" id="code" class="form-control" placeholder="Discount Code" value="{{$discountCoupon->code}}">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Discount Coupon Name" value="{{$discountCoupon->name}}">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" cols="30" rows="4" class="form-control" placeholder="Description"> {{$discountCoupon->description}}</textarea>
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="min_amount" id="min_amount" class="form-control" placeholder="Min Amount" value="{{$discountCoupon->min_amount}}">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="starts_at" id="starts_at" class="form-control" placeholder="Start AT" value="{{$discountCoupon->starts_at}}">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="expires_at" id="expires_at" class="form-control" placeholder="Expires AT" value="{{$discountCoupon->expires_at}}">	
                                <p></p>
                            </div>
                        </div>											
                    </div>
...
$("#discountCouponForm").submit(function(e){
    ...
    var element = $(this);
    $.ajax({
        url : '{{route("discount-coupon.update",$discountCoupon->id)}}',
        type : 'post',
