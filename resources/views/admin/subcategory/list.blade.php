            ...
            <form action="" method="GET">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" class="btn btn-default" onclick="window.location.href = '{{route('sub-categories.index')}}'">Reset</button>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('sub-categories.destroy',$sub_category->id)}}" class="text-danger w-4 h-4 mr-1">
