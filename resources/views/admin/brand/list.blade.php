        ...
        <form action="" method="GET">
            <div class="card-header">
                <div class="card-title">
                    <button type="button" class="btn btn-default" onclick="window.location.href = '{{route('brands.index')}}'">Reset</button>
                </div>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('brands.destroy',$brand->id)}}" class="text-danger w-4 h-4 mr-1">
